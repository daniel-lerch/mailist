...
namespace Mailist.Migrations
{
    ...
    [Migration("20260331155808_SpamFilter")]
    partial class SpamFilter
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Mailist.EmailRelay.Entities.DistributionList", b =>
                {
                    ...
                    b.Property<string>("SendersQuery")
                        .IsRequired()
                        .HasColumnType("longtext");
            ...
            modelBuilder.Entity("Mailist.EmailRelay.Entities.InboxEmail", b =>
                {
                    ...
                    b.Property<int>("SpamCategory")
                        .HasColumnType("int");

                    b.Property<string>("SpamJustification")
                        .HasColumnType("longtext");
